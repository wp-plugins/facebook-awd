...
Donate link:http://www.ahwebdev.fr
...
Facebook AWD is an all in one Facebook capabilities for wordpress.  
Add Socials plugins, Open Graph, and FB connect to your site to increase virality

<span style=\"text-decoration: underline;\">Socials plugins:</span>
...
<span style=\"text-decoration: underline;\">OpenGraph protocol</span>:

Customise Open Graph Tags for each type of posts (custom post support), archives, categories and taxonomies  
You can redefine global settings for all posts or pages or custom post type

<span style=\"text-decoration: underline;\">FB connect:</span>
...
<span style=\"text-decoration: underline;\">Multisite compatible:</span>
