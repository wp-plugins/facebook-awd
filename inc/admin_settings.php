	...
	<form method="POST" action="">
		<div id="div_options_content_tabs">
			...
			*/
			...
			<div id="settings">
				<p>
					<label class="up_label" for="<?php echo $this->plugin_option_pref; ?>parse_xfbml"><?php _e('Activate XFBML parsing ?',$this->plugin_text_domain); ?> <?php echo $this->get_the_help('xfbml'); ?></label>
				...
				<p>
					<label class="up_label" for="<?php echo $this->plugin_option_pref; ?>connect_enable"><?php _e('Activate FB Connect ?',$this->plugin_text_domain); ?> <?php echo $this->get_the_help('connect'); ?></label>
