...
<div id="message_help_activity_domain" class="hidden">
	<?php
...
<div id="message_help_show_header" class="hidden">
	<?php
	_e("Show the Facebook header on the plugin.",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_activity_recommendation" class="hidden">
	<?php
	_e("Show recommendations.",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_activity_border" class="hidden">
	<?php
	_e("The border color of the plugin.",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_login_button_css" class="hidden">
	<?php
	_e("Add custom css for the login button.",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_login_button_logout" class="hidden">
	<?php
	_e("The sentence in logout link",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_login_button_maxrow" class="hidden">
	<?php
	_e("The maximum number of rows of profile pictures to show.",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_login_button_faces" class="hidden">
	<?php
	_e("Show pictures of the user's friends who have joined your site",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_login_button_profile_picture" class="hidden">
	<?php
	_e("Show pictures of the user when connected",$this->plugin_text_domain); 
	?>
</div>

<div id="message_help_like_box_stream" class="hidden">
	<?php
