...
class AWD_facebook_widget_likebutton extends WP_Widget {
	...
	function form($instance) {
		...
		echo '
		<p>
			<label for="'.$this->get_field_id('like_button_ref').'">'._e('Ref',$this->AWD_facebook->plugin_text_domain).' 
		...
		echo '
		<p>
			<label for="'.$this->get_field_id('like_button_layout').'">'._e('Layout style',$this->AWD_facebook->plugin_text_domain).' 
		...
		echo '
		<p>
			<label for="'.$this->get_field_id('like_button_font').'">'._e('Font',$this->plugin_text_domain).' 
