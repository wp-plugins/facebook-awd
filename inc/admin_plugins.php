									...
									<tr>
										...
										<td>
											...
											<select id="<?php echo $this->plugin_option_pref; ?>like_button_layout" name="<?php echo $this->plugin_option_pref; ?>like_button_layout" class="uiSelectHTML" onchange="onchange_uiSelect(this.id);">
												<option value="standart" <?php if($this->plugin_option['like_button_layout'] == "standard") echo 'selected="selected"'; ?> ><?php echo __("Standart",$this->plugin_text_domain).' '.__('(default)',$this->plugin_text_domain); ?></option>
